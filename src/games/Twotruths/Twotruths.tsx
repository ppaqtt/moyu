...
export default function Twotruths() {
  ...
  const spawnObjects = useCallback(() => {
    ...
    const colors = ['#F472B6','#A78BFA','#22c55e','#3b82f6','#ffd700'];
    for (let i = 0; i < 6; i++) {
  ...
  return (
    <div style={{background:'#0a0a1a',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',padding:20}}>
      <motion.h1 initial={{opacity:0,y:-20}} animate={{opacity:1,y:0}} style={{color:PRIMARY,fontSize:28,marginBottom:10}}>🗣️ 两个真话一个谎</motion.h1>
      ...
      <div style={{marginTop:10,color:'#888',fontSize:14}}>方向键/WASD移动 | 社交推理，找出隐藏角色</div>
