...
export default function Ludo() {
  ...
  const [highScore, setHighScore] = useLocalStorage<number>(STORAGE_KEYS.LUDO, 0);
        ...
        <div className="flex items-center gap-4 w-full" style={{ maxWidth: CANVAS_WIDTH }}>
          ...
          <div className="flex-1 h-2 rounded-full overflow-hidden" style={{ backgroundColor: 'rgba(255,255,255,0.1)' }}>
            <motion.div
              ...
              animate={{ opacity: currentPlayer === 2 || currentPlayer === 3 ? 1 : 0.3 }}
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          {gameStatus === 'playing' && currentPlayer === 0 && (
            <motion.button
              ...
              style={{
                background: `linear-gradient(135deg, ${PLAYER_COLORS.red}, ${NEON_COLORS.accent})`,
                color: NEON_COLORS.white,
          ...
          {(gameStatus === 'playing' || gameStatus === 'selecting') && currentPlayer !== 0 && (
            <motion.div
              className="px-6 py-3 rounded-xl font-bold"
              style={{
                backgroundColor: NEON_COLORS.accent + '30',
                color: NEON_COLORS.neonBlue
              }}
