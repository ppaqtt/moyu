...
export default function Plantswar() {
  ...
  return (
    <div style={{background:'#0a0a1a',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',padding:20}}>
      <motion.h1 initial={{opacity:0,y:-20}} animate={{opacity:1,y:0}} style={{color:PRIMARY,fontSize:28,marginBottom:10}}>🌻 植物战争</motion.h1>
      ...
      <div style={{marginTop:10,color:'#888',fontSize:14}}>方向键/WASD移动 | 放置防御塔，阻止敌人前进</div>
