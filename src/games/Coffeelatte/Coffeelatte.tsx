...
export default function Coffeelatte() {
  ...
  const spawnObjects = useCallback(() => {
    ...
    const colors = ['#F97316','#FBBF24','#22c55e','#3b82f6','#ffd700'];
    for (let i = 0; i < 7; i++) {
  ...
  return (
    <div style={{background:'#0a0a1a',minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',padding:20}}>
      <motion.h1 initial={{opacity:0,y:-20}} animate={{opacity:1,y:0}} style={{color:PRIMARY,fontSize:28,marginBottom:10}}>☕ 咖啡拉花</motion.h1>
      ...
      <div style={{marginTop:10,color:'#888',fontSize:14}}>方向键/WASD移动 | 按照食谱步骤，完成烹饪挑战</div>
